...
static float Mem = 65535;//131072.0;//202025.0;
...
int main(int argc, char *argv[]) {
  ...
  //printf("tv_sec:%ld\n",Global_time);
  printf("<<<ssd_ARR=%d>>>\n",ssd_ARR);
  FILE *fwrite = fopen("/home/osnet/disksim_blas_lpb/flush.txt","w");
  FILE *fread = fopen("/home/osnet/trace/Financial1forssd_cut","r");
